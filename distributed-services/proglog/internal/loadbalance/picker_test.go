...
// TestPickerNoSubConnAvailable() tests that a picker
// initially returns balancer.ErrNoSub-ConnAvailable
// before the resolver has discovered servers and updated the picker’s
...
// tests that the picker picks the leader subconnection
// for append calls
...
//  tests that the picker picks the followers
