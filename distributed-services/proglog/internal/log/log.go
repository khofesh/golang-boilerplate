...
/*
  The log consists of a list of segments and a pointer to
  the active segment to append writes to. The directory is
...
/*
  Reader
  to ensure that we begin reading from the origin of the store
...
/*
  ...
  slice of segments, and makes the new segment the active
